<template>
  <section class="darkBg">
    <Dropdown :default="selectedFont" :onClick="onSelectFont" label="Font" :options="fonts"/>
    <Dropdown :default="selectedSlate" :onClick="onSelectSlate" label="Default Slate" :options="slates"/>
  </section>
</template>
